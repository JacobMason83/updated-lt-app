...
const Dashboard = () => {
  ...
  return (
    <Container>
      <Row>
        <Col>
          <Carousel style={{ marginBottom: '100px', marginTop: '100px' }}>
            <Carousel.Item>
              <img
                height={500}
                width={300}
      ...
      <Row>
        <Col>
          <Card
            style={{ width: '18rem', height: '25rem', color: 'orange' }}
            bg='dark'
          >
            ...
            <Card.Body>
              ...
              <Card.Text>
                This is a button link to the Properties that have been
        ...
        <Col>
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text>
                This will take you to your Messages Page, and allow you to send
        ...
        <Col>
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text>
                This will take you to the Maitanence Requests Page Fill out the
                form on here.
              </Card.Text>
              <Button variant='dark'>
                <svg
